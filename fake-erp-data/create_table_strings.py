...
({DEPRECIATION_EXPENSE_FOR_THE_PERIOD},'Depreciation Expense for the Period','Depreciation Expense for the Period',0),
({ISSUANCE_COMMON_STOCK_AT_A_PREMIUM},'Issuance of Common Stock at a Premium','Issuance of Common Stock at a Premium',0),
({ISSUANCE_COMMON_STOCK_FOR_CASH},'Issuance of Common Stock for Cash','Issuance of Common Stock for Cash',0),
({ISSUANCE_COMMON_STOCK_FOR_NON_CASH_ASSETS},'Issuance of Common Stock for Non-cash Assets','Issuance of Common Stock for Non-cash Assets',0),
({ISSUANCE_PREFERRED_STOCK_AT_A_PREMIUM},'Issuance of Preferred Stock at a Premium','Issuance of Preferred Stock at a Premium',0),
({OBTAINING_LOAN_FROM_BANK},'Obtaining a Loan from Bank','Obtaining a Loan from Bank',0),
({PAYMENT_FROM_CUSTOMERS},'Payment from Customers','Payment from Customers',92),
({PAYMENT_INCOME_TAXES},'Payment of Income Taxes','Payment of Income Taxes',0),
({PAYMENT_INSURANCE},'Payment of Insurance','Payment of Insurance',0),
({PAYMENT_INTEREST_ON_LOAN},'Payment of Interest on Loan','Payment of Interest on Loan',0),
({PAYMENT_LOAN_INSTALLMENT_TO_BANK},'Payment of Loan Installment to Bank','Payment of Loan Installment to Bank',0),
({PAYMENT_RENT_EXPENSES},'Payment of Rent Expense','Payment of Rent Expense',0),
({PAYMENT_SALARIES},'Payment of Salaries','Payment of Salaries',0),
({PAYMENT_SALES_TAXES},'Payment of Sales Taxes','Payment of Sales Taxes',0),
({PAYMENT_UTILITIES_EXPENSES},'Payment of Utilities Expense','Payment of Utilities Expense',0),
({PAYMENT_SUPPLIER},'Payment to Supplier','Payment to Supplier',148),
({PAYROLL_GENERATION},'Payroll generation','Payroll generation',0),
({PURCHASE_INVENTORY_CASH},'Purchase of Inventory on Cash','Purchase of Inventory on Cash',55),
({PURCHASE_INVENTORY_CREDIT},'Purchase of Inventory on Credit','Purchase of Inventory on Credit',93),
({PURCHASE_MACHINERY_FOR_PRODUCTION},'Purchase of Machinery for Production','Purchase of Machinery for Production',0),
({PURCHASE_OFFICE_FURNITURE},'Purchase of Office Furniture','Purchase of Office Furniture',0),
({PURCHASE_STOCKS_OF_COMPANIES},'Purchase of Stocks of companies','Purchase of Stocks of companies',0),
({PURCHASE_PRODUCTS},'Purchase products','Purchase products',0),
({ACCEPTANCE_SERVICES},'Acceptance services','Acceptance services',0),
({RECEIPT_DIVIDENDS_FROM_INVESTMENTS},'Receipt of Dividends from Investments','Receipt of Dividends from Investments',0),
({RECEIPT_PAYMENT_FROM_CUSTOMER},'Receipt of Payment from Customer','Receipt of Payment from Customer',0),
({RETIREMENT_COMMON_STOCK},'Retirement of Common Stock','Retirement of Common Stock',0),
({RETURN_PRODUCTS_ON_CASH},'Return of Products on Cash','Return of Products on Cash',0),
({RETURN_PRODUCTS_ON_CREDIT},'Return of Products on Credit','Return of Products on Credit',0),
({SALE_BONDS},'Sale of Bonds','Sale of Bonds',0),
({SALE_OLD_MACHINERY},'Sale of Old Machinery','Sale of Old Machinery',0),
({SALES_CASH},'Sale of Products on Cash','Sale of Products on Cash',90),
({SALES_CREDIT},'Sale of Products on Credit','Sale of Products on Credit',97),
({RETURN_PRODUCTS_ON_CREDIT_NOTES},'Return products on credit notes','Return products on credit notes',0),
({LAYAWAY_SALES},'Layaway Sales','Revenue from goods sold that are put on layaway for the customer.',0),
({GIFT_CARD_SALES},'Gift Card Sales','Revenue received from selling gift cards.',0),
({SERVICE_REVENUE},'Service Revenue','Revenue from services provided, such as delivery or product customization.',0),
({CUSTOMER_RETURNS_AND_REFUNDS},'Customer Returns and Refunds','Transactions where customers return goods for a refund.',0),
({DISCOUNTS_GIVEN},'Discounts Given','Discounts applied to sales.',0),
({INVENTORY_PURCHASES},'Inventory Purchases','Purchases of goods intended for resale.',0),
({FREIGHT_IN},'Freight-In','Costs associated with shipping inventory to the store.',0),
({PURCHASE_RETURNS},'Purchase Returns','Transactions related to returning goods to suppliers.',0),
({PAYMENT_MORTGAGE_EXPENSES},'Payment Mortgage Expense','Payment of mortgages',0),
({UTILITIES},'Utilities','Expenses for utilities like electricity, water, and internet.',0),
({SALARIES_AND_WAGES},'Salaries and Wages','Compensation for employees.',0),
({INSURANCE_REIMBURSEMET},'Insurance reimbursement','Insurance reimbursements for the business',0),
({PURCHASE_ADVERTISING},'Advertising','Costs of promotional activities.',0),
({PURCHASE_SUPPLIES},'Supplies','Purchase of supplies necessary for operation.',0),
({DEPRECIATION},'Depreciation','Depreciation on long-term assets like fixtures and equipment.',0),
({MAINTENANCE_AND_REPAIRS},'Maintenance and Repairs','Costs for maintaining and repairing equipment and premises.',0),
({INTEREST_INCOME},'Interest Income','Income from investments.',0),
({INTEREST_EXPENSES},'Interest Expense','Interest paid on loans.',0),
({LOAN_PROCEEDS},'Loan Proceeds','Receipt of loan funds.',0),
({LOAN_REPAYMENTS},'Loan Repayments','Repayment of loan principal.',0),
({BANK_FEES},'Bank Fees','Fees charged by banks for account maintenance and transactions.',0),
({PENALTIES_AND_FINES},'Penalties and Fines','Costs associated with penalties or fines incurred by the business.',0),
({DONATIONS},'Donations','Charitable contributions made by the business.',0),
({INSURANCE_AMORTIZATION},'Insurance amortization', 'Insurance amortization' , 0 ),
({PAYMENT_LEASE_AGREEMENT},'Payment Lease Agreement', 'Payment Lease Agreement' , 0 ),
({PAYMENT_SERVICES},'Payment services','Payment services ',0) ; 
"""

str_create_table['ledger_accounts'] = f"""
-- Accounts Table
...
({LEDGER_CASH}, 'Cash', 'Physical currency and coins, as well as balances in checking and savings accounts.', 'Assets', 'D'),
({LEDGER_ACCOUNTS_RECEIVABLE}, 'Accounts Receivable', 'Amounts owed to the company by customers for goods or services provided on credit.', 'Assets', 'D'),
({LEDGER_INVENTORY}, 'Inventory', 'Goods available for sale, including raw materials, work-in-progress, and finished goods.', 'Assets', 'D'),
({LEDGER_FIXED_ASSETS}, 'Fixed Assets', 'Long-term tangible assets used in the operation of the business, such as land, buildings, and machinery.', 'Assets', 'D'),
({LEDGER_INVESTMENTS}, 'Investments', 'Financial Investments', 'Assets', 'D'),
({LEDGER_ACCOUNTS_PAYABLE}, 'Accounts Payable', 'Amounts owed by the company to suppliers or vendors for goods or services purchased on credit.', 'Liabilities', 'C'),
({LEDGER_LOANS_PAYABLE}, 'Loans Payable', 'Amounts borrowed by the company from financial institutions or other lenders.', 'Liabilities', 'C'),
({LEDGER_TAXES_PAYABLE}, 'Taxes Payable', 'Taxes owed by the company to government authorities, such as income taxes and sales taxes.', 'Liabilities', 'C'),
({LEDGER_COMMON_STOCK}, 'Common Stock', 'Ownership equity representing the amount invested by shareholders in the company.', 'Equity', 'C'),
({LEDGER_ADDITIONAL_PAID_IN_CAPITAL}, 'Additional Paid-in Capital', '' , 'Equity', 'C'),
({LEDGER_RETAINED_EARNINGS}, 'Retained Earnings', 'Accumulated earnings or losses of the company that have not been distributed to shareholders as dividends.', 'Equity', 'C'),
({LEDGER_SALES_REVENUE}, 'Sales Revenue', 'Revenue generated from the sale of goods or services to customers.', 'Revenue', 'C'),
({LEDGER_INTEREST_INCOME}, 'Interest Income', 'Income earned from interest on loans, investments, or other interest-bearing assets.', 'Revenue', 'C'),
({LEDGER_COST_OF_GOODS_SOLD}, 'Cost of Goods Sold', 'Expenses incurred to obtained goods sold','Expenses','D'),
({LEDGER_OPERATING_EXPENSES}, 'Operating Expenses', 'Expenses incurred in the normal course of business operations, such as rent, utilities, and wages.', 'Expenses', 'D'),
({LEDGER_INTEREST_EXPENSES}, 'Interest Expenses' , 'Expenses incurred by loans','Expenses', 'D' ),
({LEDGER_TAX_EXPENSES}, 'Tax expenses', 'Expenses incurred by taxes', 'Expenses', 'D' ),
({LEDGER_PREPAID_INSURANCE_EXPENSES}, 'Prepaid Insurance Expense', 'Prepaid Insurance Expense', 'Expenses', 'D' ) ,
({LEDGER_INSURANCE_REIMBURSEMENT_INCOME}, 'Insurance Reimbursement Income', 'Insurance Reimbursement Income', 'Revenue', 'D' ),
({LEDGER_INSURANCE_EXPENSES}, 'Insurance Expense', 'Insurance Expense', 'Expense', 'D' ) ,
({LEDGER_PREFERRED_STOCK}, 'Preferred stock', 'Preferred stock', 'Equity', 'C') , 
({LEDGER_FIXED_INVESTMENTS}, 'Fixed investments', 'Fixed investments', 'Assets', 'D'),
({LEDGER_NON_CASH_ASSETS}, 'Non-cash assets','Non-cash assets','Assets','D'),
({LEDGER_ACCUMULATED_DEPRECIATION}, 'Accumulated depreciation', 'Accumulated depreciation', '', 'D' ),
({LEDGER_DEPRECIATION_EXPENSE}, 'Depreciation expense', 'Depreciation expense','', 'D' ),
({LEDGER_DIVIDEND_INCOME}, 'Dividend income', 'Dividend income', '','D') ; 
"""



str_create_table['entry_types'] = f"""
...
INSERT INTO entry_type (id, transaction_type_id, ledger_account_id, debit_credit) VALUES
(1  ,{PURCHASE_INVENTORY_CASH},{LEDGER_INVENTORY},'D'),
(2  ,{PURCHASE_INVENTORY_CASH},{LEDGER_CASH},'C'),

(3  ,{PURCHASE_INVENTORY_CREDIT},{LEDGER_INVENTORY},'D'),
(4  ,{PURCHASE_INVENTORY_CREDIT},{LEDGER_ACCOUNTS_PAYABLE},'C'),

(5  ,{PAYMENT_SUPPLIER},{LEDGER_ACCOUNTS_PAYABLE},'D'),
(6  ,{PAYMENT_SUPPLIER},{LEDGER_CASH},'C'),

(7  ,{ACCEPTANCE_SERVICES},{LEDGER_ACCOUNTS_PAYABLE},'C'),
(8  ,{ACCEPTANCE_SERVICES},{LEDGER_OPERATING_EXPENSES},'D'),

(9  ,{PAYMENT_SERVICES},{LEDGER_ACCOUNTS_PAYABLE},'D'),
(10 ,{PAYMENT_SERVICES},{LEDGER_CASH},'C'),

(11 ,{PAYROLL_GENERATION},{LEDGER_ACCOUNTS_PAYABLE},'C'),
(12 ,{PAYROLL_GENERATION},{LEDGER_ACCOUNTS_RECEIVABLE},'C'),
(13 ,{PAYROLL_GENERATION},{LEDGER_OPERATING_EXPENSES},'D'),

(14 ,{PAYMENT_SALARIES},{LEDGER_ACCOUNTS_PAYABLE},'D'),
(15 ,{PAYMENT_SALARIES},{LEDGER_CASH},'C'),

(16 ,{SALES_CASH},{LEDGER_INVENTORY,},'C'),
(17 ,{SALES_CASH},{LEDGER_COST_OF_GOODS_SOLD},'D'),
(18 ,{SALES_CASH},{LEDGER_SALES_REVENUE},'C'),
(20 ,{SALES_CASH},{LEDGER_CASH},'D'),

(21 ,{SALES_CREDIT},{LEDGER_INVENTORY,},'C'),
(22 ,{SALES_CREDIT},{LEDGER_COST_OF_GOODS_SOLD},'D'),
(23 ,{SALES_CREDIT},{LEDGER_SALES_REVENUE},'C'),
(24 ,{SALES_CREDIT},{LEDGER_ACCOUNTS_RECEIVABLE},'D'),

(25 ,{PAYMENT_FROM_CUSTOMERS},{LEDGER_ACCOUNTS_RECEIVABLE},'C'),
(26 ,{PAYMENT_FROM_CUSTOMERS},{LEDGER_CASH},'D'),

(27 ,{RETURN_PRODUCTS_ON_CASH},{LEDGER_INVENTORY,},'D'),
(28 ,{RETURN_PRODUCTS_ON_CASH},{LEDGER_COST_OF_GOODS_SOLD},'C'),
(29 ,{RETURN_PRODUCTS_ON_CASH},{LEDGER_SALES_REVENUE},'D'),
(30 ,{RETURN_PRODUCTS_ON_CASH},{LEDGER_CASH},'C'),

(31 ,{RETURN_PRODUCTS_ON_CREDIT_NOTES},{LEDGER_INVENTORY,},'D'),
(32 ,{RETURN_PRODUCTS_ON_CREDIT_NOTES},{LEDGER_COST_OF_GOODS_SOLD},'C'),
(33 ,{RETURN_PRODUCTS_ON_CREDIT_NOTES},{LEDGER_SALES_REVENUE},'D'),
(34 ,{RETURN_PRODUCTS_ON_CREDIT_NOTES},{LEDGER_ACCOUNTS_RECEIVABLE},'C'),

(35 ,{PAYMENT_RENT_EXPENSES},{LEDGER_OPERATING_EXPENSES},'D'),
(36 ,{PAYMENT_RENT_EXPENSES},{LEDGER_CASH},'C'),

(37 ,{PAYMENT_SALES_TAXES},{LEDGER_TAX_EXPENSES},'D'),
(38 ,{PAYMENT_SALES_TAXES},{LEDGER_CASH},'C'),

(39 ,{OBTAINING_LOAN_FROM_BANK},{LEDGER_CASH},'D'),
(40 ,{OBTAINING_LOAN_FROM_BANK},{LEDGER_LOANS_PAYABLE},'C'),

(41 ,{PAYMENT_LOAN_INSTALLMENT_TO_BANK},{LEDGER_LOANS_PAYABLE},'D'),
(42 ,{PAYMENT_LOAN_INSTALLMENT_TO_BANK},{LEDGER_CASH},'C'),

(43 ,{INSURANCE_REIMBURSEMET},{LEDGER_CASH},'D'),
(44 ,{INSURANCE_REIMBURSEMET},{LEDGER_INSURANCE_REIMBURSEMENT_INCOME},'C'),

(45 ,{INSURANCE_AMORTIZATION},{LEDGER_PREPAID_INSURANCE_EXPENSES},'D'),
(46 ,{INSURANCE_AMORTIZATION},{LEDGER_INSURANCE_EXPENSES},'C'),

(47 ,{PAYMENT_INSURANCE},{LEDGER_PREPAID_INSURANCE_EXPENSES},'D'),
(48 ,{PAYMENT_INSURANCE},{LEDGER_CASH},'C'),

(49 ,{PAYMENT_UTILITIES_EXPENSES},{LEDGER_OPERATING_EXPENSES},'D'),
(50 ,{PAYMENT_UTILITIES_EXPENSES},{LEDGER_CASH},'C'),

(51 ,{PAYMENT_INTEREST_ON_LOAN}, {LEDGER_INTEREST_EXPENSES}, 'D'),
(52 ,{PAYMENT_INTEREST_ON_LOAN}, {LEDGER_CASH}, 'C'),

(53 ,{PAYMENT_INCOME_TAXES}, {LEDGER_TAXES_PAYABLE}, 'D'),
(54 ,{PAYMENT_INCOME_TAXES}, {LEDGER_CASH}, 'C'),

(55 ,{PURCHASE_MACHINERY_FOR_PRODUCTION}, {LEDGER_FIXED_ASSETS}, 'D'),
(56 ,{PURCHASE_MACHINERY_FOR_PRODUCTION}, {LEDGER_ACCOUNTS_PAYABLE}, 'C'),
(57 ,{PURCHASE_OFFICE_FURNITURE}, {LEDGER_FIXED_ASSETS}, 'D'),
(58 ,{PURCHASE_OFFICE_FURNITURE}, {LEDGER_ACCOUNTS_PAYABLE}, 'C'),
(59 ,{SALE_OLD_MACHINERY}, {LEDGER_CASH}, 'D'),
(60 ,{SALE_OLD_MACHINERY}, {LEDGER_ACCUMULATED_DEPRECIATION}, 'D'),
(61 ,{SALE_OLD_MACHINERY}, {LEDGER_FIXED_ASSETS}, 'C'),
(62 ,{DEPRECIATION_EXPENSE_FOR_THE_PERIOD}, {LEDGER_DEPRECIATION_EXPENSE}, 'D'),
(63 ,{DEPRECIATION_EXPENSE_FOR_THE_PERIOD}, {LEDGER_ACCUMULATED_DEPRECIATION}, 'C'),
(64 ,{PURCHASE_STOCKS_OF_COMPANIES}, {LEDGER_FIXED_INVESTMENTS}', 'D'),
(65 ,{PURCHASE_STOCKS_OF_COMPANIES}, {LEDGER_CASH}, 'C'),
(66 ,{SALE_BONDS}, {LEDGER_CASH}, 'D'),
(67 ,{SALE_BONDS}, {LEDGER_FIXED_INVESTMENTS}, 'C'),
(68 ,{RECEIPT_DIVIDENDS_FROM_INVESTMENTS}, {LEDGER_CASH}, 'D'),
(69 ,{RECEIPT_DIVIDENDS_FROM_INVESTMENTS}, {LEDGER_DIVIDEND_INCOME}, 'C'),
(70 ,{ISSUANCE_COMMON_STOCK_FOR_CASH}, {LEDGER_CASH}, 'D'),
(71 ,{ISSUANCE_COMMON_STOCK_FOR_CASH}, {LEDGER_COMMON_STOCK}, 'C'),
(72 ,{ISSUANCE_COMMON_STOCK_FOR_NON_CASH_ASSETS}, {LEDGER_NON_CASH_ASSETS}, 'D'),
(73 ,{ISSUANCE_COMMON_STOCK_FOR_NON_CASH_ASSETS}, {LEDGER_COMMON_STOCK}, 'C'),
(74 ,{RETIREMENT_COMMON_STOCK}, {LEDGER_COMMON_STOCK}, 'D'),
(75 ,{RETIREMENT_COMMON_STOCK}, {LEDGER_RETAINED_EARNINGS}, 'C'),
(76 ,{ISSUANCE_COMMON_STOCK_AT_A_PREMIUM}, {LEDGER_CASH}, 'D'),
(77 ,{ISSUANCE_COMMON_STOCK_AT_A_PREMIUM}, {LEDGER_COMMON_STOCK}, 'C'),
(78 ,{ISSUANCE_COMMON_STOCK_AT_A_PREMIUM}, {LEDGER_ADDITIONAL_PAID_IN_CAPITAL}, 'C'),
(79 ,{ISSUANCE_PREFERRED_STOCK_AT_A_PREMIUM}, {LEDGER_CASH}, 'D'),
(80 ,{ISSUANCE_PREFERRED_STOCK_AT_A_PREMIUM}, {LEDGER_PREFERRED_STOCK}, 'C'),
(81 ,{ISSUANCE_PREFERRED_STOCK_AT_A_PREMIUM}, {LEDGER_ADDITIONAL_PAID_IN_CAPITAL}, 'C') ; 
"""



str_create_table['business_processes'] = """
...
str_create_table['service_orders'] = """
...
CREATE TABLE contracts (
    ...
    branch_id INT NOT NULL REFERENCES Branches(id),
    expense_category_id INT not null REFERENCES revenue_expense_categories(id),
    revenue_category_id INT REFERENCES revenue_expense_categories(id),
    business_unit_id int not null REFERENCES business_units(id),
...
str_create_table['paymentschedule'] = """
...
INSERT INTO branches (id, name, location_id) VALUES
(1, 'Central Square', 1),
...
str_create_table['unit_measures'] = """
...
str_create_table['business_units'] = """
...
str_create_table['revenue_expense_categories'] = """
...
str_create_table['customer_segments'] = """
...
str_create_table['vendor_categories'] = """
...
str_create_table['product_categories'] = """
...
str_create_table['payment_statuses'] = """
...
str_create_table['sp_order_statuses'] = """
...
str_create_table['payment_methods'] = """
...
str_create_table['payment_terms'] = """
...
str_create_table['utility_types'] = """
-- Utility Type Table
...
INSERT INTO utility_types (id, name, description) VALUES
...
str_create_table['contract_types'] = """
...
(2, 'Mortgage', 44, 7),
(3, 'Insurance Policy', 9,7),
(4, 'Lease agreement', 61, 3),
(5, 'Utility contract', 15, 7);
"""


str_create_table['expensecategories'] = """
...
str_create_table['sales_channels'] = """
-- Sales Channel Table
...
CREATE TABLE promotions (
    ...
    start_date DATE,
    end_date DATE,
    productcategory_id INT REFERENCES product_categories(id),
    discount_rate DECIMAL(5, 2)
);


INSERT INTO promotions (id, name, description, start_date, end_date, productcategory_id, discount_rate) VALUES
...
str_create_table['employeeroles'] = """
...
CREATE TABLE parties (
 ...
 utility_type_id int references utility_types(id)
);
"""


str_create_table['parties_types'] = """
...
str_create_table['vendors'] = """
-- Table for service vendors
...
str_create_table['taxauthorities'] = """
...
str_create_table['service_providers'] = """
...
str_create_table['taxliabilities'] = """
...
str_create_table['chart_of_accounts'] = """
...
str_create_table['depreciationschedule'] = """
...
str_create_table['amortizationschedule'] = """
...
str_create_table['financialaccounts'] = """
...
str_create_table['interesttransactions'] = """
